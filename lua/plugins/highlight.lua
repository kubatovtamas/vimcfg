return {
	...
	config = function()
		...
		-- Set up keybindings for Illuminate plugin commands
		local opts = { noremap = true, silent = true }

		-- Keybinding for going to the next reference
		vim.api.nvim_set_keymap("n", "<leader>gn", "<cmd>lua require('illuminate').goto_next_reference(true)<CR>", { noremap = true, silent = true, desc = "[N]ext Reference" })
